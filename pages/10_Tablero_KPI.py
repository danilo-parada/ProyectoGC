...
# Salvaguardamos las columnas datetime para que, aunque falten campos en la fuente,
# siempre obtengamos series válidas y evitemos el NameError detectado por QA.
fac_l = _safe_to_datetime(df_pag_contab_loc.get("fac_fecha_factura"))
cc_l = _safe_to_datetime(df_pag_contab_loc.get("fecha_cc"))
pago_l = _safe_to_datetime(df_pag_contab_loc.get("fecha_pagado"))
